    ...
    <div class="container mt-5">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="region" role="tabpanel" aria-labelledby="region-tab">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <!-- List existing regions with edit and delete buttons -->
                        <ul class="list-group">
            ...
            <div class="tab-pane fade" id="zone" role="tabpanel" aria-labelledby="zone-tab">
                <!-- Zone Management -->
                <!-- Your existing zone management content here -->
                <!-- Zone Management -->
                <div class="card">
                    <div class="card-header">Zones</div>
                    <div class="card-body">
                        <!-- Add zone management form -->
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                            <div class="form-group">
                        ...
                        <hr>
                        <!-- List existing zones with edit and delete buttons -->
                        <ul class="list-group">
                            <?php
                            $zones = getZones($conn);
            ...
            <div class="tab-pane fade" id="woreda" role="tabpanel" aria-labelledby="woreda-tab">
                <!-- Woreda Management -->
                <!-- Your existing woreda management content here -->
                <!-- Woreda Management -->
                <div class="card">
                    <div class="card-header">Woredas</div>
                    <div class="card-body">
                        <!-- Add woreda management form -->
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                            <div class="form-group">
                                <input type="text" name="woreda_name" class="form-control" placeholder="Enter Woreda Name" required>
                            </div>
                            <div class="form-group">
                        ...
                        <hr>
                        <!-- List existing woredas with edit and delete buttons -->
                        <ul class="list-group">
                            <?php
                            // Function to get all woredas
            ...
            <div class="tab-pane fade" id="city" role="tabpanel" aria-labelledby="city-tab">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <!-- List existing cities with edit and delete buttons -->
                        <ul class="list-group">
                            <?php
                            // Function to get all cities
            ...
            <div class="tab-pane fade" id="kebele" role="tabpanel" aria-labelledby="kebele-tab">
                <!-- Kebele Management -->
                <!-- Your existing kebele management content here -->
                <!-- Kebele Management -->
                <div class="card">
                    <div class="card-header">Kebeles</div>
                    <div class="card-body">
                        <!-- Add kebele management form -->
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                            <div class="form-group">
                                <input type="text" name="kebele_name" class="form-control" placeholder="Enter Kebele Name" required>
                            </div>
                            <div class="form-group">
                        ...
                        <hr>
                        <!-- List existing kebeles with edit and delete buttons -->
                        <ul class="list-group">
                            <?php
                            // Function to get all kebeles
